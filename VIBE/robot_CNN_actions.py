...
from robot_generate_expert_data import get_random_tcp_start_pos


def move_robot_with_cnn():
    """ load the model of the CNN and """
    # load cnn module
    Resnet = CNN(False, model_name="180Traj_Natural_Resnet34.pth")
    # use it to

    from robot_generate_expert_data import get_smart_random_grasp_release_positions
    n_steps_taken = 0
...
if __name__ == "__main__":
    ...
    model_names = (
        ...
        # '180Traj_Natural_Resnet34.pth',
        # 'natural_p200_2.pth',
        # 'natural_p150_3.pth',
        # 'natural_p150_without_2.pth',
        # 'colouredcubes.pth',
        # 'natural_p150_2_res34.pth',
        # 'res34-250trj.pth',
        # 'res34-50trj.pth',
        'each2000_best.pth',
        # 'nathan_test.pth
